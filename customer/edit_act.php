...
<div class="box">
	...
	<div class="form-group">
		...
		<img src="customer-images/<?php echo $customer_image ?>"class="img-thumbnail"height="100"width="100">
	</div>
	<div class="text-center">
		<button class="btn btn-primary"name="update"type="submit">Update Now</button>
	</div>
	</form>
</div>
<?php
if (isset($_POST['update'])) {
	...
	move_uploaded_file($c_image_temp,"customer-images/$c_image");
	$update_cust="update customers set customer_name='$c_name',customer_email='$c_email',customer_country='$c_country',customer_city='$c_city',customer_contact='$c_contact',customer_address='c_address',customer_image='$c_image'where customer_id='$update_id'";
